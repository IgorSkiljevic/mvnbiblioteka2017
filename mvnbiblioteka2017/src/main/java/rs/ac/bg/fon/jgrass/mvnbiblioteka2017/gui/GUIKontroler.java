...
import rs.ac.bg.fon.jgrass.mvnbiblioteka2017.Biblioteka;
import rs.ac.bg.fon.jgrass.mvnbiblioteka2017.Knjiga;
import rs.ac.bg.fon.jgrass.mvnbiblioteka2017.interfejsi.BibliotekaInterfejs;
...
public class GUIKontroler {
	...
	public static void ugasiAplikaciju() {
		int odgovor = JOptionPane.showConfirmDialog(glavniProzor, "Da li zelite da zatvorite aplikaciju?", "Zatvaranje",
	...
	public static void dodajKnjigu(String naslov, String isbn, String izdavac, int izdanje, String ime1,
			String prezime1, String ime2, String prezime2) {
		try {
			Knjiga k = new Knjiga();
			k.setNaslov(naslov);
			...
			e.printStackTrace();
			JOptionPane.showMessageDialog(null, e.getMessage(), "Greska u cuvanju knjige!", JOptionPane.ERROR_MESSAGE);
		}
	}
